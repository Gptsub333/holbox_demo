  ...
  useEffect(() => {
    ...
    menuContent.innerHTML = `
      ...
      <nav style="display: flex; flex-direction: column; gap: 8px;">
        <a href="/" style="display: flex; align-items: center; padding: 12px; border-radius: 8px; background-color: ${
          pathname === "/" ? "#f3f4f6" : "transparent"
        ...
        <a href="/upcoming" style="display: flex; align-items: center; padding: 12px; border-radius: 8px; background-color: ${
          pathname === "/upcoming" ? "#f3f4f6" : "transparent"
