...
const PromptInput = ({ prompt, setPrompt, handlePromptSelect, handleEdit, isProcessing, selectedImage, error, filteredSuggestions, showSuggestions, setShowSuggestions, setFilteredSuggestions, filterSuggestions }) => {
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-md p-6">
              ...
              <div className="mt-2 flex justify-between items-center ">
                <div className="text-xs text-gray-500">{prompt.length} / 500 characters</div>
                <button
                  onClick={() => {
                    if (showSuggestions && Object.keys(filteredSuggestions).length > 0) {
                ...
                >
                  {(showSuggestions && Object.keys(filteredSuggestions).length > 0) ? 'Hide suggestions' : 'Show suggestions'}
                </button>
              </div>
