...
import { Upload, Camera, X, ZoomOut, ZoomIn, RotateCcw } from 'lucide-react'

const ImageUpload = ({ imagePreview, dragOver, clearImage, setZoom, zoom, handleFileSelect, setDragOver }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-md p-6 mb-6">
      <h2 className="text-xl font-semibold mb-4">Headshot Image</h2>
