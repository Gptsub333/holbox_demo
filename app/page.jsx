...
const TooltipLabel = ({ text, show }) => (
  <div
    className={`absolute left-full ml-3 top-1/2 -translate-y-1/2 bg-gray-900 text-white px-3 py-2 rounded-md text-lg whitespace-nowrap z-[9999] transition-all duration-300 ease-out pointer-events-none ${
      show
            ...
            <div className="max-w-4xl mx-auto p-4 md:p-8">
              <section className="flex flex-col justify-center mt-[150px]">
                <div className="text-center mb-5 md:mb-8">
                  ...
                  <p className="text-gray-600 text-base md:text-base text-balance">
                    Discover smarter conversations, automated insights, and
                    limitless creativity — all in one dashboard. Let's set you
              ...
              <div
                className={`transition-all duration-500 ease-in-out overflow-hidden ${
                  showTemplates
                    ? "max-h-[2000px] opacity-100 mb-8 md:mb-12"
                  ...
                  <div className="flex items-center gap-3 mb-2 md:mb-3">
                    ...
                    <textarea
                      ...
                      onInput={(e) => {
                        ...
                        target.style.height = "auto";
                        target.style.height =
                          Math.min(target.scrollHeight, 64) + "px";
                      }}
                    />
                    <Button
                      size="sm"
