...
export default function HealthScribePage() {
  ...
  const handleTranscribe = async () => {
    ...
    try {
      const response = await fetch(
        "https://demo.holbox.ai/api/healthbox/transcription/start",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleChatSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://demo.holbox.ai/api/healthbox/qa/query`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-[calc(5rem+5px)] right-10 flex flex-col items-end space-y-4">
        <motion.button
